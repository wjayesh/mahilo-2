...
12. Re-read the task docs on the integration branch to see whether the task moved to `done`, `blocked`, or remains active.
13. Repeat until all tracked tasks are complete or the loop limit is reached.
