...
export declare class MahiloContractClient {
    ...
    sendMessage(payload: Record<string, unknown>, idempotencyKey?: string): Promise<unknown>;
    reportOutcome(payload: Record<string, unknown>, idempotencyKey?: string): Promise<unknown>;
    createOverride(payload: Record<string, unknown>, idempotencyKey?: string): Promise<unknown>;
    listReviews(params?: {
        limit?: number;
        status?: string;
    }): Promise<unknown>;
    decideReview(reviewId: string, payload: Record<string, unknown>): Promise<unknown>;
