...
Use these copy blocks for npm, GitHub, OpenClaw listing drafts, release notes, and other publish surfaces.

## One-Line Promise

Ask your contacts from OpenClaw and get real answers from people you trust, with attribution and boundaries built in.

## Short Marketplace/Package Description
...
## Publish Surfaces That Should Stay Aligned

- `package.json` description and keywords
- `openclaw.plugin.json` description
- `README.md` opening promise and Start Here links
- `PUBLISH-CHECKLIST.md` publish-surface review step
